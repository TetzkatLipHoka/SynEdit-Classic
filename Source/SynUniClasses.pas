...
type
  ...
  public
    ...
    property Symbols[Index: Integer]: string read GetSymbol write SetSymbol; //нужн?index добавить ?туда #0
  end;
  ...
  //TODO: возможно стои?ег?сделат?наследнико?TAbstractSynSymbol
...
begin
  ...
  //# fOpenRule  := ASynSymbol.fOpenRule; //TODO: На?этим надо подумать... (см. SafeInsertToken)
...
begin
  Result := Default;
  try //??? ?Designer 2.0 выскакивае?AV

...
begin
  with AKeyList, ANode do begin
    ...
    ImportAttributes(AKeyList.Attributes, ChildNodes[0{%SchemeIndex}]); //TODO: ��������?
...
begin
  with ASet, ANode do begin
    Name := VarToStr(GetVarAttr('Name',''));
    ImportAttributes(ASet.Attributes, ChildNodes[0{%SchemeIndex}]); //TODO: ��������?
    //???Enabled := StrToBoolDef(EnsureChild('Enabled').Text, True);
...
begin
  with ARange, ANode do begin
    Name := VarToStr(GetVarAttr('Name',''));
    //TODO: ������?���������� Num ��?�������� SynSet (���� Num <> Def)
    ImportAttributes(ARange.Attributes, EnsureChild('Def'));
    ImportAttributes(ARange.Attributes, ChildNodes[0{%SchemeIndex}]); //TODO: ��������?
    //???Enabled := StrToBoolDef(EnsureChild('Enabled').Text, True);
    OpenToken.Clear();
    CloseToken.Clear();
